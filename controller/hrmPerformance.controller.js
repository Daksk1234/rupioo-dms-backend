// File: controller/hrmPerformance.controller.js
import { HrmPerformance } from "../model/hrmPerformance.model.js";
import { buildController, number } from "./_hrmAdvancedCommon.js";
const c = buildController({
  Model: HrmPerformance,
  label: "Performance",
  beforeSave: (row) => {
...
export const createPerformance = c.create;
export const listPerformance = c.list;
export const viewPerformance = c.view;
export const updatePerformance = c.update;
export const transitionPerformance = c.transition;
export const deletePerformance = c.remove;
export const reportPerformance = c.report;
