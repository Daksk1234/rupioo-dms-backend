// File: controller/hrmNotification.controller.js
import { HrmNotification } from "../model/hrmNotification.model.js";
import { buildController, number } from "./_hrmAdvancedCommon.js";
const c = buildController({
  Model: HrmNotification,
  label: "Notification",
  beforeSave: (row) => {
...
export const createNotification = c.create;
export const listNotification = c.list;
export const viewNotification = c.view;
export const updateNotification = c.update;
export const transitionNotification = c.transition;
export const deleteNotification = c.remove;
export const reportNotification = c.report;
