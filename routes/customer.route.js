...
import {
  ...
  CreateSalesLeadSingle,
  AssignLeadParty,
  Check,
  DeleteBulkCustomer,
  DeleteCustomer,
  DeleteSalesLead,
  DeleteSalesLeadMultiple,
  GPSReport,
  LeadPartyList,
  LeadPartyListById,
  PartyWithSalesPerson,
  SaveCustomer,
  SaveLeadPartyExcel,
  SaveRemark,
  SignIn,
...
router.post(
  "/update-customer-bulk-import/:database",
  uploads.single("file"),
  updateExcelFile
);
...
router.get("/lead-lookup-by-pincode/:database/:pincode", LeadLookupByPincode);
router.put("/update-lead-status/:id", UpdateSalesLeadStatus);
...
router.post("/create-sales-lead/:database", CreateSalesLeadSingle);
