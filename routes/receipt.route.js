...
import {
  ...
  ViewOtp,
  ViewReceiptById,
  ViewReceiptByPartyId,
  ViewReceiptBySalesPersonId,
  savePayment,
  savePaymentWithExcel,
  saveReceipt,
  saveReceiptWithExcel,
...
router.post(
  "/reciept-data/:database",
  uploads.single("file"),
  saveReceiptWithExcel,
);
router.post(
  "/payment-data/:database",
  uploads.single("file"),
  savePaymentWithExcel,
);
...
router.get(
  "/view-salesperson-receipt/:id/:database",
  ViewReceiptBySalesPersonId,
);
